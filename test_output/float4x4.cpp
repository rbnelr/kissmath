...
namespace kissmath {
	...
	// extend/truncate matrix of other size
	float4x4::operator float2x3 () const {
	...
	// typecast
	float4x4::operator double4x4 () const {
		return double4x4((double)arr[0][0], (double)arr[0][1], (double)arr[0][2], (double)arr[0][3],
						 (double)arr[1][0], (double)arr[1][1], (double)arr[1][2], (double)arr[1][3],
						 (double)arr[2][0], (double)arr[2][1], (double)arr[2][2], (double)arr[2][3],
						 (double)arr[3][0], (double)arr[3][1], (double)arr[3][2], (double)arr[3][3]);
	}
	...
	float4x4 operator* (float4x4 const& l, float4x4 const& r) {
		return float4x4::columns(l * r.arr[0],
								 l * r.arr[1],
								 l * r.arr[2],
								 l * r.arr[3]);
	}
	...
	float4 operator* (float4x4 const& l, float4 r) {
		return float4(l.arr[0].x * r.x + l.arr[1].x * r.y + l.arr[2].x * r.z + l.arr[3].x * r.w,
	...
	float4 operator* (float4 l, float4x4 const& r) {
		return float4(l.x * r.arr[0].x + l.y * r.arr[0].y + l.z * r.arr[0].z + l.w * r.arr[0].w,
