...
namespace kissmath {
	...
	float3::float3 (float all): x{all}, y{all}, z{all} {
	...
	// type cast operator
	float3::operator int8v3 () const {
		return int8v3((int8)x, (int8)y, (int8)z);
	}
	
	// type cast operator
	float3::operator int16v3 () const {
	...
	// type cast operator
	float3::operator uint16v3 () const {
	...
	// type cast operator
	float3::operator uint64v3 () const {
