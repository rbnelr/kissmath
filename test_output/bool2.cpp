...
namespace kissmath {
	...
	// type cast operator
	bool2::operator double2 () const {
		return double2((double)x, (double)y);
	}
	
	// type cast operator
	bool2::operator int8v2 () const {
		return int8v2((int8)x, (int8)y);
	}
	
	// type cast operator
	bool2::operator int16v2 () const {
	...
	// type cast operator
	bool2::operator uint16v2 () const {
		return uint16v2((uint16)x, (uint16)y);
	}
	
	// type cast operator
	bool2::operator uint2 () const {
		return uint2((uint)x, (uint)y);
	}
	
	// type cast operator
	bool2::operator uint64v2 () const {
