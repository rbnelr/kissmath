...
namespace kissmath {
	...
	// extend/truncate matrix of other size
	float3x3::operator float2x3 () const {
	...
	// typecast
	float3x3::operator double3x3 () const {
		return double3x3((double)arr[0][0], (double)arr[0][1], (double)arr[0][2],
						 (double)arr[1][0], (double)arr[1][1], (double)arr[1][2],
						 (double)arr[2][0], (double)arr[2][1], (double)arr[2][2]);
	}
